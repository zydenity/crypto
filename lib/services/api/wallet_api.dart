...
class WalletApi {
  WalletApi._(this.baseUrl) {
    if (kDebugMode) debugPrint('[WalletApi] baseUrl=$baseUrl');
  }
  ...
  static String _detectBaseUrl() {
    ...
    // Adjust if you host elsewhere.
  }

  static final WalletApi instance = WalletApi._(_detectBaseUrl());
