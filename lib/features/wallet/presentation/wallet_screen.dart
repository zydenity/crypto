...
class _WalletScreenState extends State<WalletScreen>
  ...
  final tabs = const ['Wallet', 'Swap', 'Stake', 'Invest', 'Trade', 'Grow'];
          ...
          SliverAppBar(
            ...
            title: Row(
              children: [
                ...
                const Text('Hello!', style: TextStyle(fontWeight: FontWeight.w600)),
              ],
            ),
            actions: [
              IconButton(
              ...
              Padding(
                ...
                child: FilledButton.tonal(
                  ...
                  child: Text(
                    connectedAddress == null ? 'Connect' : 'Connected',
            ...
            bottom: PreferredSize(
              ...
              child: Container(
                ...
                child: TabBar(
                  ...
                  tabs: tabs.map((t) => Text(t, style: const TextStyle(fontWeight: FontWeight.w600))).toList(),
                ),
              ),
            ),
          ),
